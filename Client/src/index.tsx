...
import { loginFormUri, loginUri, requestUri, selfFormUri, selfProfileUri, selfUri, userFormUri, userUri } from './apiConfig';
    ...
    <BrowserRouter>
        <App>
            <Switch>
                ...
                <Route path='/profile/edit' component={() => <FormPage formUri={selfFormUri} actionUri={selfUri} FormComponent={EditForm}/>} />
